...
/*    
    ai->SetStartDifficulty(masterSession->GetPlayer()->GetDungeonDifficulty());
    ai->SetStartInstanceID(masterSession->GetPlayer()->GetInstanceId());
    ai->SetStartMapID(masterSession->GetPlayer()->GetMapId());
    ai->SetStartZoneID(masterSession->GetPlayer()->GetZoneId());
    ai->SetStartAreaID(masterSession->GetPlayer()->GetAreaId());
    ai->SetStartO(masterSession->GetPlayer()->GetOrientation());
    ai->SetStartX(masterSession->GetPlayer()->GetPositionX());
    ai->SetStartY(masterSession->GetPlayer()->GetPositionY());
    ai->SetStartZ(masterSession->GetPlayer()->GetPositionZ());
*/
    ...
    (masterSession->m_playerBots)[guid] = botPlayer;
     /* Player* _player = masterSession->GetPlayer();
     botPlayer->SaveRecallPosition();
     botPlayer->TeleportTo(botPlayer->GetMapId(), botPlayer->GetPositionX(), botPlayer->GetPositionY(), botPlayer->GetPositionZ(), botPlayer->GetOrientation());
     */
